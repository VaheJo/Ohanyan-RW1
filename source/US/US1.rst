...
Так же можно обратить внимание на наружную ось глаза, но анализируя лиетратуту 
можно сдлеать вывод, что на УЗИ изображении всегда видны минимум два органа из вышеперечисленных.
...
пока не найдется наилучшее совпадение(для наглядности см рис. 5.6.1)

.. figure:: images/2DUZI.png
    :scale: 100 %
    :align: center
    :alt: 2DUZI

    Накладывание 2D УЗИ и изображения фундус камеры на КТ.
